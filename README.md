...
O **Spectrum** foi desenvolvido com foco em **didática, reprodutibilidade e extensibilidade**, permitindo:

- Inclusão futura de novas técnicas de processamento (ex.: filtragem de ruído, segmentação, limiarização);
- Integração com uma interface gráfica interativa;
